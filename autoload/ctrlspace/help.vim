...
let s:descriptions = {
      ...
      \ "ctrlspace#keys#buffer#DeleteForgottenBuffers":       "Delete (close) all forgotten buffers (unrelated to any tab)",
      ...
      \ "ctrlspace#keys#tab#CollectForgottenBuffers":         "Create a new tab with forgotten buffers",
